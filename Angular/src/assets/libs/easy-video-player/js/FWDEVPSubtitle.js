		...
		self.parseSubtitle = function(file_str){
		    ...
		    for(s in srt_) {
		        ...
		        if(st.length >=2) {
		            ...
		            self.subtitiles_ar[cont].startDuration =  FWDEVPUtils.formatTimeWithMiliseconds(i);
		            self.subtitiles_ar[cont].endDuration = FWDEVPUtils.formatTimeWithMiliseconds(o);
