...
(function (window){
	...
	var FWDConsole = function(){
		...
		this.setupScreen = function(){
			this.main_do = new FWDEVPDisplayObject("div", "absolute");
    ...
    FWDConsole.setPrototype = function(){
    	FWDConsole.prototype = new FWDEVPDisplayObject("div", "absolute");
    };
    
    FWDConsole.prototype = null;
	window.FWDConsole = FWDConsole;
}(window));﻿/* FWDEVPAdsButton */
(function (window){
...
(function (){
	var FWDEVPContextMenu = function(e, showMenu){
		...
		this.contextMenuWindowOnMouseDownHandler = function(e){
			...
			if(!FWDEVPUtils.hitTest(self.menu_do.screen, screenX, screenY)){
				if(window.removeEventListener){
		...
		this.setupMenus = function(){
			...
			this.menu_do = new FWDEVPDisplayObject("div");
			self.menu_do.setX(-500);
			this.menu_do.getStyle().width = "100%";
			
			this.normalMenu_do = new FWDEVPDisplayObject("div");
			...
			this.selectedMenu_do = new FWDEVPDisplayObject("div");
			...
			this.over_do = new FWDEVPDisplayObject("div");
...
(function (window){
	 ...
	 */
	var FWDEVPDisplayObject = function(type, position, overflow, display){
		...
		this.hasTransform3d_bl =  FWDEVPUtils.hasTransform3d;
		this.hasTransform2d_bl =  FWDEVPUtils.hasTransform2d;
		if(FWDEVPUtils.isFirefox || FWDEVPUtils.isIE) self.hasTransform3d_bl = false;
		if(FWDEVPUtils.isFirefox || FWDEVPUtils.isIE) self.hasTransform2d_bl = false;
		...
		self.addChild = function(e){
			if(self.contains(e)){	
				self.children_ar.splice(FWDEVPUtils.indexOfArray(self.children_ar, e), 1);
		...
		self.contains = function(e){
			if(FWDEVPUtils.indexOfArray(self.children_ar, e) == -1){
				return false;
			}else{
				return true;
			}
		...
		self.addChildAt = function(e, index){
			if(self.getNumChildren() == 0){
				...
				if(self.contains(e)){
					self.children_ar.splice(FWDEVPUtils.indexOfArray(self.children_ar, e), 1, e);
				}else{
					self.children_ar.splice(FWDEVPUtils.indexOfArray(self.children_ar, e), 0, e);
				}
			}else{
		...
		self.getChildIndex = function(child){
			if(self.contains(child)){
				return FWDEVPUtils.indexOfArray(self.children_ar, child);
			}
			return 0;
		};
	...
	window.FWDEVPDisplayObject = FWDEVPDisplayObject;
}(window));/* Info screen */
(function (window){
...
(function(window){
	...
	var FWDEVPFacebookShare = function(appId){
		
		var self = this;
		var prototype = FWDEVPFacebookShare.prototype;
	...
	/* set prototype */
	FWDEVPFacebookShare.setPrototype = function(){
		FWDEVPFacebookShare.prototype = new FWDEVPEventDispatcher();
	};
	
	FWDEVPFacebookShare.prototype = null;
	
	window.FWDEVPFacebookShare = FWDEVPFacebookShare;
}(window));﻿/* FWDEVPFlashButton */
(function (window){
...
}(window));var FWDEVPFlashTest = function() {
...
(function (window){
	 ...
	 */
	var FWDEVPTransformDisplayObject = function(type, position, overflow, display){
		...
		this.addChild = function(e){
			if(this.contains(e)){	
				this.children_ar.splice(FWDEVPUtils.indexOfArray(this.children_ar, e), 1);
		...
		this.contains = function(e){
			if(FWDEVPUtils.indexOfArray(this.children_ar, e) == -1){
				return false;
			}else{
				return true;
			}
		...
		this.addChildAtZero = function(e){
			if(this.numChildren == 0){
				...
				if(this.contains(e)){this.children_ar.splice(FWDEVPUtils.indexOfArray(this.children_ar, e), 1);}	
	...
	window.FWDEVPTransformDisplayObject = FWDEVPTransformDisplayObject;
}(window));﻿/* thumbs manager */
(function(window){
