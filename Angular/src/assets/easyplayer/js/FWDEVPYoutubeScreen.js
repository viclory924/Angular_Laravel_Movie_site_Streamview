...
(function(window){
	...
	var FWDEVPYoutubeScreen = function(parent, volume){
		...
		this.playsinline = parent.data.playsinline ? 1 : 0;
		...
		this.updateVideo = function(){
			...
			self.dispatchEvent(FWDEVPYoutubeScreen.UPDATE_TIME, {curTime:curTime , totalTime:totalTime, seconds:parseInt(self.ytb.getCurrentTime()), totalTimeInSeconds:self.ytb.getDuration()});
		};
		...
		this.updateSubtitleHandler = function(){
			...
			self.dispatchEvent(FWDEVPYoutubeScreen.UPDATE_SUBTITLE, {curTime:self.ytb.getCurrentTime()});
		}
