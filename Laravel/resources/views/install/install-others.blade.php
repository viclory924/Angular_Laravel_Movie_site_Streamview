		...
		<form action="{{route('install.settings')}}" method="POST" enctype="multipart/form-data" role="form">
			<div class="install-settings-inner">
				<div class="row no-margin" style="margin-bottom:10px;">
					...
					<p class="text-justify">{{tr('install_notes')}}
					</p>
					</div>
				</div>
				<div class="set-image">
					...
					<div class="row no-margin">
						...
						<div class="col-sm-6 col-xs-12">
							<div class="form-group">
					    		...
					    		<input type="file" name="site_logo" class="form-control-file" accept="image/png,image/jpeg" id="exampleInputFile" aria-describedby="fileHelp">
							</div><!--end of form-group-->
						</div><!--end of column-->
					</div><!--end of row-->
					<div class="row no-margin">
						<div class="col-sm-6 col-xs-12">
							<div class="form-group">
					    		...
					    		<input type="file" name="site_icon" class="form-control-file" id="fav_icon" accept="image/png,image/jpeg" aria-describedby="fileHelp">
							</div><!--end of form-group-->
						</div><!--end of column-->
						<div class="col-sm-6 col-xs-12">
							<div class="form-group">
