                        ...
                        <div class="row">
                          <div class="col-lg-12 row">
                            <div class="col-lg-6">
                                ...
                                <p class="text-muted">
                                    {{ category($video->sub_category_id) }}
                                </p>
                                <hr>
                                <!-- end -->
                                  <!-- start -->
                                <strong><i class="fa fa-suitcase margin-r-5"></i> Alternative Titles</strong>
                                @if($video->alternative_titles && is_array(json_decode($video->alternative_titles)))
                                ...
                                <!-- end -->
                                 <!-- start -->
                                <strong><i class="fa fa-suitcase margin-r-5"></i> Is slider?</strong>
                                <p class="text-muted">
                                    {{ $video->is_home_slider==1 ? "Yes":'No' }}
                                </p>
                                <hr>
                                <!-- end -->
                                  <!-- start -->
                                <strong><i class="fa fa-suitcase margin-r-5"></i> Is Banner?</strong>
                                <p class="text-muted">
                                    {{ $video->is_banner==1 ? "Yes":'No' }}
                                </p>
                                <hr>
                                <!-- end -->
                                <!-- start -->
                                ...
                                <!-- end -->
                                  <!-- start -->
                                <strong><i class="fa fa-clock-o margin-r-5"></i>Release Date </strong>
                                <p class="text-muted">
                                    {{$video->release_date}}
                                </p>
                                <hr>
                                ...
                                <hr>
                                 <strong><i class="fa fa-upload margin-r-5"></i> {{tr('moderator')}}</strong>
                                <p class="text-muted">
                                        {{  moderator($video->moderator_id) }}
                                </p>
                                <hr>
                                ...
                                <!-- end -->
                                  <!-- start -->
                                <strong><i class="fa fa-male margin-r-5"></i> Actors</strong>
                                <p class="text-muted">
                                    {{  shwoCastAndCrews($video->actors) }}
                                </p>
                                <hr>
                                <!-- end -->
                                <!-- start -->
                                <strong><i class="fa fa-male margin-r-5"></i> Directors</strong>
                                <p class="text-muted">
                                    {{  shwoCastAndCrews($video->directors) }}
                                </p>
                                <hr>
                                <!-- end -->
                                 <!-- start -->
                                <strong><i class="fa fa-male margin-r-5"></i> Writers</strong>
                                <p class="text-muted">
                                    {{  shwoCastAndCrews($video->writers) }}
                                </p>
                                <hr>
                                <!-- end -->
                            ...
                            <!-- Images start -->
                            <div class="col-lg-6">
                                <h4 class="text-uppercase"><i class="fa fa-file-picture-o margin-r-5"></i> {{tr('default_image')}}</h4>
