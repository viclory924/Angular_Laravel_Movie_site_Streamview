                        ...
                        <div class="">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" min="1" name="publish_time" placeholder="{{tr('select_publish_time')}}" class="form-control pull-right" id="datepicker">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                  ...
                                  <!-- <small> {{tr('duration_note')}}</small> -->
                                    <div class="input-group">
                                        ...
                                        <input required type="text" name="duration" class="form-control" data-inputmask="'alias': 'hh:mm:ss'" data-mask id="duration" placeholder="{{tr('duration_note')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" id="age" name="age" placeholder="{{tr('age')}} : {{tr('example_format')}}" maxlength="3">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea  style="overflow:auto;resize:none" class="form-control" rows="4" cols="50" name="details" id="ckeditor"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="genre_id">
                                    <div class="form-group">
                                        ...
                                        <select id="genre" name="genre_id" class="form-control select2" style="width: 100%" disabled>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <label style="margin-top:10px" id="video_upload">
                                            <input required type="radio" name="video_type" value="1"  checked>
                                ...
                                <div id="upload">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <label style="margin-top:10px">
                                                <input type="radio" name="video_upload_type" value="2" checked>
                                                {{tr('direct')}}
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div id="others">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="url" class="form-control" id="other_trailer_video" name="other_trailer_video" placeholder="{{tr('trailer_video')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-lg-12">
                                    <label>{{tr('send_notification')}}</label>&nbsp;&nbsp;<input type="checkbox" name="send_notification" class="minimal-red" value="1" />
                                </div>
                            </div>
                        </div>
