...
@section('content')
	<div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          	<div class="small-box bg-dark-info">
            	<div class="inner">
              		<h3>{{$video_count}}</h3>
              		<p>{{tr('total_videos')}}</p>
            	</div>
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-dark-blue">
                <div class="inner">
                    <h3>{{Setting::get('currency')}} {{number_format_short(($total_revenue > 0 && $total_revenue != '') ? $total_revenue : 0)}}</h3>
        ...
        <div class="col-md-8">
            <div class="box">
                <div class="box-header bg-blue">
                    <h3 class="box-title text-uppercase">{{tr('daily_view_count')}}</h3>
        ...
        <div class="col-md-4">
            <div class="box">
                <div class="box-header with-border bg-blue">
                    <h3 class="box-title text-uppercase">{{tr('registered_users')}}</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
                        <!-- <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button> -->
