...
<p class="text-justify" style="color:brown;"><b>{{tr('please_note')}}: </b> {{tr('banner_short_notes')}}</p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="genre_id">
                                <div class="form-group">
                                    ...
                                    <select id="genre" name="genre_id" class="form-control select2" disabled>
                                        <option value="">{{tr('select_genre')}}</option>
                                    </select>
                                </div>
                            </div>
                            <input type="hidden"  name="is_banner" value="1" id="is_banner">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
