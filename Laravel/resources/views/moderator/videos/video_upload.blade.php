                        ...
                        <div class="">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="display: none">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="publish_time" placeholder="{{tr('select_publish_time')}}" class="form-control pull-right" id="datepicker" value="0000-00-00 00:00:00">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="genre_id">
                                <div class="form-group">
                                    ...
                                    <select id="genre" name="genre_id" style="width: 100%" class="form-control select2" disabled>
                            ...
                            <div id="upload">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <label style="margin-top:10px">
                                            <input type="radio" name="video_upload_type" value="2" checked> {{tr('direct')}}
                                        </label>
                                    </div>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script src="{{asset('assets/js/malsup-jquery.form.js')}}"></script>
