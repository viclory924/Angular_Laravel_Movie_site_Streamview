                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
                        ...
                        <div class="">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label>{{tr('duration')}} * : </label><small> {{tr('format_must')}}</small>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                             ...
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea  style="overflow:auto;resize:none" class="form-control" rows="4" cols="50" name="details" id="ckeditor">{{$video->details}}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="complete">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                               <small style="color:brown">{{tr('video_notes_moderator')}}</small>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <label style="margin-top:10px" >
                                            <input type="radio" @if(!check_s3_configure()) disabled @endif name="video_upload_type" value="1" @if($video->video_upload_type == 1) checked @endif>
                                            {{tr('s3')}}
                                        </label>
                                        @endif
                                        <label style="margin-top:10px">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var video_id = "{{$video->admin_video_id}}";
