                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="mcnButtonContent" style=" font-size: 18px; font-family:'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;padding: 10px 25px;" valign="middle" align="center">
                                                                                    <a class="mcnButton " title="Visit Video" href="{{Setting::get('ANGULAR_SITE_URL')}}" target="_self" style="letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit Website</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
