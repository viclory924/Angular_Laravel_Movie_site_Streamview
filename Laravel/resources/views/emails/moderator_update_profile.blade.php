...
<table class="mcnButtonBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:0px; padding-bottom:18px; padding-left:0px;" class="mcnButtonBlockInner" valign="top" align="center">
                    ...
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style=" font-size: 18px; font-family:'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;padding: 10px 25px;" valign="middle" align="center">
                                <a class="mcnButton " title="Watch Video" href="{{route('moderator.dashboard')}}" target="_self" style="letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Content Creator Login</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
