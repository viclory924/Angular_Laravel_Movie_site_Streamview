...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <style type="text/css">
        ...
        #templateBody{
            ...
            background-image:url({{asset('images/email2.jpg')}});
            background-position:center;
                                                            ...
                                                            <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                <tbody><tr>
                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                        <h1>Welcome to {{Setting::get('site_name')}}</h1>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            </table>
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        <td class="mcnTextContent" style="padding: 0px 18px 9px; font-size: 19px; text-align: center;" valign="top">
                            <?= $email_data['content'];?>
                           <?php /* @if(Setting::get('email_verify_control'))
                                To get started using {{Setting::get('site_name')}}, please confirm your account below : 
                            @endif */?>
                        </td>
                    </tr>
                </tbody></table>
...
<table class="mcnButtonBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody class="mcnButtonBlockOuter">
        <tr>
            ...
            <td style="padding-top:0; padding-right:0px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center">
                    ...
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style=" font-size: 18px; font-family:'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;padding: 10px 25px;" valign="middle" align="center">
                                <a class="mcnButton " title="Watch Video" href="{{route('email.verify' , ['id' => $email_data['user_id'] , 'verification_code' => $email_data['verification_code']])}}" target="_self" style="letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Confirm Your Account</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            @endif
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:0px;" class="mcnButtonBlockInner" valign="top" align="center">
                <table class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #E50914;" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style=" font-size: 18px; font-family:'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;padding: 10px 25px;" valign="middle" align="center">
                                <a class="mcnButton " title="Watch Video" href="{{Setting::get('ANGULAR_SITE_URL')}}" target="_self" style="letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit our Website</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                                            ...
                                                            <tbody><tr>
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left">
                                                                    <table width="" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                        <tbody><tr>
                                                                                <td class="mcnFollowIconContent" width="24" valign="middle" align="center">
                                                                                    <a href="{{Setting::get('linkedin_link')}}" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-linkedin-48.png" style="display:block;" class="" width="24" height="24"></a>
                                                                                </td>
                                                                        </tr>
                                                                    </tbody></table>
                                                                </td>
                                                            ...
                                                            <tbody><tr>
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left">
                                                                    <table width="" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                        <tbody><tr>
                                                                                <td class="mcnFollowIconContent" width="24" valign="middle" align="center">
                                                                                    <a href="{{Setting::get('google_plus_link')}}" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-googleplus-48.png" style="display:block;" class="" width="24" height="24"></a>
                                                                                </td>
                                                                        </tr>
                                                                    </tbody></table>
                                                                </td>
                                                            ...
                                                            <tbody><tr>
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left">
                                                                    <table width="" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                        <tbody><tr>
                                                                                <td class="mcnFollowIconContent" width="24" valign="middle" align="center">
                                                                                    <a href="{{Setting::get('pinterest_link')}}" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-pinterest-48.png" style="display:block;" class="" width="24" height="24"></a>
                                                                                </td>
                                                                        </tr>
                                                                    </tbody></table>
                                                                </td>
        ...
        <tr>
            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            <em>Copyrights 2017 . All rights reserved.</em>
                        </td>
                    </tr>
                </tbody></table>
            </td>
