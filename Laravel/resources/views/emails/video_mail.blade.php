...
<table class="mcnTextBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                 <img src="{{$email_data['video_image']}}" style="height: 250px;width:100%" />
            </td>
        </tr>
    </tbody>
</table>
                    ...
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style=" font-size: 18px; font-family:'Lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;padding: 10px 25px;" valign="middle" align="center">
                                <a class="mcnButton " title="Watch Video" href="{{Setting::get('ANGULAR_SITE_URL')}}" target="_self" style="letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">View Video</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
