    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        <td class="mcnTextContent" style="padding: 0px 18px 9px 35px; font-size: 19px; text-align: center;" valign="top">
                            <p><b>{{tr('hi')}}</b> {{$email_data['name']}} ,</p>
                            <p><?= isset($email_data['mailcamp_content']) ? $email_data['mailcamp_content'] : "" ?></p>
                        </td>
                    </tr>
                </tbody></table>
            </td>
