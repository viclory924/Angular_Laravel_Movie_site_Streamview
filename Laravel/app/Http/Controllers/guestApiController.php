...
/**
    ...
    public function browse(Request $request) {
        ...
        //     ->limit(12)
        //     ->get();
      //  $response_array = ['recent'=>$recent,'slider'=>$slider];
    ...
    public function showVideoDetails(Request $request) {
        $id = $request->admin_video_id;
        $sub_profile_id = $request->sub_profile_id;
        $data = displayFullDetails($id, $sub_profile_id);
        return response()->json(['success'=>true, 'data'=>$data]);
    }          
    /**
