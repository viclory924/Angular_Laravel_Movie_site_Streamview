...
$('form').ajaxForm({
    ...
    error : function(xhr) {
        ...
        $("#"+final).text("Submit");
        $("#"+final).attr('disabled', false);
        alert("Error: While Uploading Video some error occured. Please Try Again. Make sure upload file is meets with server upload limit.");
        error = true;
        return false;
        // console.log(xhr);
    },
    success : function(xhr) {
        ...
        if(xhr.id != '' && xhr.id != undefined) {
            ...
            if (xhr.error_code == 500) {
                ...
                alert("Success: While Uploading Video some error occured. Please Try Again. Make sure upload file is meets with server upload limit.");
            }
            error = true;
